...
public class CategoryServiceImpl implements ICategoryService {
    ...
    public ServerResponse<String> addCategory(Integer parentId,String categoryName){
        if(parentId==null || StringUtils.isBlank(categoryName)){
            return ServerResponse.createByErrorMessage("创建失败，参数错误");
        }
    ...
    public ServerResponse<String> updateCategoryName(Integer categoryId, String categoryName) {
        if(categoryId==null || StringUtils.isBlank(categoryName)){
            return ServerResponse.createByErrorMessage("修改失败，参数错误");
        }
        Category category=new Category();
    ...
    @Override
    public ServerResponse getGategoryAndDeepChildrenCategory(Integer categoryId) {
